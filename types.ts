...
export type Page = 'landing' | 'login' | 'signup' | 'forgot_password' | 'onboarding' | 'job_search' | 'job_details' | 'job_seeker_dashboard' | 'employer_dashboard' | 'admin_dashboard' | 'company_profile' | 'messaging' | 'create_job';
